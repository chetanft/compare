      ...
      {figmaData && (
        <div className="mt-8">
          <div className="bg-white shadow rounded-lg p-6">
            <h2 className="text-2xl font-bold mb-4">Figma Extraction Results</h2>
            <div className="mb-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{figmaData.metadata.extractionMethod}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Extracted At</p>
                  ...
                  {figmaData.tokens.colors.map((color, index) => {
                    ...
                    return (
                      <div key={index} className="flex flex-col items-center">
                        ...
                        />
                        <span className="text-xs mt-1 text-gray-600 font-medium">{color.name || `Color ${index + 1}`}</span>
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-500">Elements Extracted</p>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID/Classes</th>
